...
\frame{
    \begin{lemma}[Definability of forcing]
        % TODO better wording
        The relation ``$\sigma \forces \varphi$'' is defined by $\Sigma_{n+1}$ in variables: $\varphi \in \Sigma_n$, $\sigma \in \{0,1\}^*$.
    \end{lemma}
...
\frame{
    ...
    \only<4>{\begin{proof}
        ...
        \begin{align*}
            (\exists \vec \sigma) & ((\forall i \in \{1, \ldots, n\}) \text{ minimal $\sigma_i$ s.t.}\\
