...
\begin{itemize}
    ...
    \item Subspace and sublocale/subframe, dense sublocale, empty frame (\emptyFrm), $\iota_S\colon L \to S$ as subframe inclusion and as onto frame homomorphisms? (the next part needs it)
