...
In this chapter, we will show that the fact that some property, such as extremal disconnectedness, is preserved by compactification is not automatic. We will prove that non-trivial compactification of metrizable frame is never metrizable.
...
\begin{proof}
    ...
    By~(\oldref{e:ballsIntersect}) it is sound to choose a sequence $(a_n)_{n=1}^\infty$ (using (CDC)) such that
    \begin{align*}
