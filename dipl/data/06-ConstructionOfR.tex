...
\num For any basically complete frame homomorphism between two extremally disconnected Stone frames, as we see from~\ref{p:boolenizationCond} and~\ref{p:basicalMorphs} and from the fact that
    \begin{align*}
