...
\begin{proposition}
    Let $H$ be a Heyting algebra, then $\Bo H$, with joins and meets defined
...
\num Until the end of this section, we will use the following Lemma frequently and without further referencing.
