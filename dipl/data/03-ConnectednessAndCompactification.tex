...
\num As a consequence of Hofmann--Lawson's Duality~\cite{hofmann1978spectral} we obtain
\begin{theorem}
    Each regular compact frame is spatial.\ACP
\end{theorem}
...
To simplify the notation, we will omit the superscript for the closure of in a sublocales compactification if there is no danger in confusion.
